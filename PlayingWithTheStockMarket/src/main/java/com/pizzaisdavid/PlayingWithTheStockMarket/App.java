...
public class App 
{
  ...
  {
    Transaction transaction = getStocks("19.35 19.30 18.88 18.93 18.95 19.03 19.00 18.97 18.97 18.98");
      System.out.println(transaction);
  }
  
  public static Transaction getStocks(String rawInput) {
    ArrayList<Double> prices = parsePrices(rawInput);
    Transaction highestProfit = null;
    for (Double buyPrice : prices) {
      for (Double sellPrice : prices) {
